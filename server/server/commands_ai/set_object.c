...
void set_object(this_t *this, player_t *player, int exec)
{
    ...
    if (object_to_set_food(this, player) == 1)
        return;
    if (object_to_set_linemate(this, player) == 1)
        return;
    if (objet_to_set_deraumere(this, player) == 1)
        return;
    if (object_to_set_sibur(this, player) == 1)
        return;
    if (object_to_set_mendiane(this, player) == 1)
        return;
    if (object_to_set_phiras(this, player) == 1)
        return;
    if (object_to_set_thystame(this, player) == 1)
        return;
